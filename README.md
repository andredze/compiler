...
##### 1) Frontend, переводящий исходный файл в *AST* (Abstract Syntax Tree):
```bash
...
<p align="center">
    ...
    <br><i>Графический дамп AST после фронтенда</i>
</p>

##### 2) Backend, переводящий AST в объектный ELF-файл, а также ассемблерный файл на *nasm*:
```bash
    ./back ast/fib.txt
```

##### 3) Компиляцию библиотеки *lib.c*.

##### 4) Линковку получившихся объектных файлов.

Исполняемые файлы находятся в директории **exec**.
...
### Пример программы, рекурсивно считающей факториал:
...
В языке присутствует поддержка графики с помощью библиотеки SDL2.
...
<p align="center">
    <img src="assets/circle_sdl.png" width="50%">
    <br><i>Круг, рисуемый данной программой при помощи SDL2</i>
</p>
