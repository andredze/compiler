...
//                      code,         repeat_times,         name                  ast_format                asm_function    asm_name src_function
    ...
    SET_OP_CASE_(OP_BIGGER_EQUAL        ,   1,   L"больше или равен"            , L"_LOG_MORE_EQUAL_", NULL                   , L"JB"  , SrcCompareOperator),
    SET_OP_CASE_(OP_SMALLER             ,   1,   L"меньше"                      , L"_LOG_LESS_"      , NULL                   , L"JAE" , SrcCompareOperator),
    SET_OP_CASE_(OP_SMALLER_EQUAL       ,   1,   L"меньше или равен"            , L"_LOG_LESS_EQUAL_", NULL                   , L"JA"  , SrcCompareOperator),
